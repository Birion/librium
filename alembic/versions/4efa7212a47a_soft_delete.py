...
def upgrade():
    ...
    op.add_column('author', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('book', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('format', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('genre', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('language', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('publisher', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('series', sa.Column('deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    ...
    op.create_index('idx_book_authors_idx', 'book_authors', ['book_id', 'idx'], unique=False)
    op.create_index('idx_book_uuid', 'book', ['uuid'], unique=False)
    op.create_index('idx_series_index_idx', 'series_index', ['book_id', 'idx'], unique=False)
...
def downgrade():
    ...
    op.create_index(op.f('idx_series_index__series'), 'series_index', ['series_id', 'book_id'], unique=False)
    op.create_index(op.f('idx_series_index__book_idx'), 'series_index', ['book_id', 'idx'], unique=False)
    ...
    op.create_index(op.f('idx_book_publishers'), 'book_publishers', ['publisher_id'], unique=False)
    op.create_index(op.f('idx_book_languages'), 'book_languages', ['language_id'], unique=False)
    ...
    op.create_index(op.f('idx_book_authors_book_idx'), 'book_authors', ['book_id', 'idx'], unique=1)
    op.create_index(op.f('idx_book_authors__book_idx'), 'book_authors', ['book_id', 'idx'], unique=False)
    op.create_index(op.f('idx_book_authors__author'), 'book_authors', ['author_id'], unique=False)
    ...
    op.create_index(op.f('idx_author_first_name'), 'author', ['first_name'], unique=False)
