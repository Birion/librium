...
class TestBookService(TestServiceBase):
    ...
    def test_get_by_uuid(self, mock_session):
        ...
        mock_session_instance = MagicMock()
        mock_session.return_value.__enter__.return_value = mock_session_instance
        mock_session_instance.execute.return_value.scalar_one_or_none.return_value = mock_book
    ...
    def test_get_all(self, mock_session):
        ...
        mock_session_instance = MagicMock()
        mock_session.return_value.__enter__.return_value = mock_session_instance
        mock_session_instance.query.return_value.filter.return_value = [mock_book1, mock_book2]
    ...
    def test_create(self, mock_session):
        ...
        with patch('librium.services.book.FormatService.get_by_id') as mock_format_service:
